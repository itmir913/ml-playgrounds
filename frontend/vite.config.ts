...
export default defineConfig({
  ...
  test: {
     ...
     *
     * **다른 세션이 같은 기기에서 다시 쟀고 방향이 재현됐다**: 6이 72.6·74.4·75.2초,
     * 8이 76.2·82.0·82.8초로 **범위가 안 겹친다.** (그 세션이 처음에 "8이 더 빠르다"고
     * 적었던 것은 **표본 하나로 방향을 말한 것**이었다 — 이 기기는 같은 설정에서도
     * 10%가 흔들리므로 **한 번 재고 방향을 주장하면 안 된다.**)
     *
